...
class PrimeSelector(Gtk.Window):
    ...
    def __init__(self):
	Gtk.Window.__init__(self, title="PRIME Selector")
	grid = Gtk.Grid()
	...
	nvidia_image = Gtk.Image.new_from_file("images/nvidia-logo.png")
	intel_image = Gtk.Image.new_from_file("images/intel-logo.png")
